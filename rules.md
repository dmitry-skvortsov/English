...
### Active
#### Использвание
- Используется чтобы говорить о завершенном действии с результатом в настоящем
...
## Past Continuous
### Использвание
- чтобы рассказать о событиях которые были в процессе в определенное время в прошлом
...
### Использвание
 ...
 - временные ситуации
 - спланированные и которые точно случатся планы
...
##### Когда не понятно какой именно элемент упоминается
...
##### С уникальными объектами(the sun, the moon etc.)
- The Earth goes round the Sun.
##### Здания, места и организации, которые вы часто видите или посещаете
...
##### С играми и спортом
- Anna plays football
##### С приемами пищи, заболеваниями, методами путешествий, месяцами, днями, периодами времени, школьными предметами
...
### if выражения, используются для разговора о воображаемых или неопределенных ситуациях в будущем
#### First conditional 
